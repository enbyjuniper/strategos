import { ListIcon, XIcon, ArrowClockwiseIcon, SunIcon, MoonIcon } from '@phosphor-icons/react';
...
export function Header({ army, isOpen, onToggle, theme, onToggleTheme }: Props) {
